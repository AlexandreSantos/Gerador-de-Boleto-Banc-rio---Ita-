...
<table width=666 cellspacing=0 cellpadding=0 border=0><tr><td width="620" valign=top class=cp><DIV ALIGN="CENTER">Instruções
de Impressão</DIV></TD>
    <td width="46" valign=top class=cp>&nbsp;</TD>
</TR><TR><TD valign=top class=cp><DIV ALIGN="left">
...
&nbsp;&nbsp;&nbsp;&nbsp;Valor: &nbsp;&nbsp;R$ <?php echo $dadosboleto["valor_boleto"]?><br>
  ...
  <img src="imagens/impressora.gif" alt="Imprimir" width="46" height="30" border="0">
  </a>
  </td>
</tr></table>
